...
x <- iris [1:50, 1] #setosa
y <- iris [51:100, 1] #versicolor
z <- iris [101:150, 1] #virginica

t.test(x, y) # setosa and versicolor
t.test(x, z) # setosa and virginica 
t.test(y, z) # versicolor and virginica

#professor way of doing it
